package nid.xfl.compiler.swf.tags
{
	...
	import nid.xfl.compiler.swf.data.SWFMorphFillStyle;
	import nid.xfl.compiler.swf.data.SWFMorphLineStyle;
	...
	public class TagDefineMorphShape implements IDefinitionTag
	{
		...
		public function toString(indent:uint = 0):String {
			var i:uint;
			var indent2:String = StringUtils2.repeat(indent + 2);
			var indent4:String = StringUtils2.repeat(indent + 4);
