package nid.xfl.compiler.swf.factories
{
	...
	import nid.xfl.compiler.swf.data.actions.swf3.*;
	import nid.xfl.compiler.swf.data.actions.swf4.*;
	import nid.xfl.compiler.swf.data.actions.swf5.*;
	import nid.xfl.compiler.swf.data.actions.swf6.*;
	import nid.xfl.compiler.swf.data.actions.swf7.*;
